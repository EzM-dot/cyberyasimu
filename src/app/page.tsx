...
export default function HomePage() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-4">
      <Card className="w-full max-w-sm sm:max-w-md shadow-2xl rounded-xl overflow-hidden bg-card/80 backdrop-blur-sm"> {/* Added transparency to card for gradient to show through subtly */}
